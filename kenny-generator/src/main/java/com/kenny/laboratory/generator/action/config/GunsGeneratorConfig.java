package com.kenny.laboratory.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setPassword("3DSmart");
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/laboratory?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.kenny.laboratory.admin.common.persistence.model");
        packageConfig.setMapper("com.kenny.laboratory.admin.common.persistence.dao");
        packageConfig.setXml("com.kenny.laboratory.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.kenny.laboratory.admin");
        contextConfig.setCoreBasePackage("com.kenny.laboratory.core");
