package com.kenny.laboratory.generator.engine.config;
...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add("com.kenny.laboratory.core.common.annotion.Permission");
        imports.add("com.kenny.laboratory.core.common.exception.BizExceptionEnum");
        imports.add("com.kenny.laboratory.core.exception.GunsException");
        imports.add("org.springframework.validation.BindingResult");
        imports.add("javax.validation.Valid");
        imports.add("com.kenny.laboratory.core.shiro.ShiroKit");
        imports.add("com.kenny.laboratory.core.util.ToolUtil");
