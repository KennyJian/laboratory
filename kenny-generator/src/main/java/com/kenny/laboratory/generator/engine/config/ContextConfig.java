...
public class ContextConfig {
    ...
    private String proPackage = "com.kenny.laboratory.admin";
    private String coreBasePackage = "com.kenny.laboratory.core";
    private String modelPackageName = "com.kenny.laboratory.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.kenny.laboratory.modular.system.dao";    //model的dao
